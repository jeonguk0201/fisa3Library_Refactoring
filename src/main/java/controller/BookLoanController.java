...
public class BookLoanController {
	 ...
	 * @return 모든 Project
	 */
	public void getBooksList() { // 핑초
		EndView.BookListView(service.getBooksList());
	}

	public void insertBook(Book book) { // 핑초
	...
	public void getBookTitle(String BookTitle) { // 핑초
		EndView.BookListView(service.getBook(BookTitle));
	}

	public void insertBookLoan(Loan loan) { // 연희
...
//		Book book = service.getBookTitle(bookTitle);
	...
	public void getUserHistory(String loanPerson) { // 연희
	...
	public void updateBookLoan(int index, Loan loan) { // 유나
	...
	public void deleteBookLoan(Loan loan) { // 유나
